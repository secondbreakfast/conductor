class RunsController < ApplicationController
  ...
  private
    ...
    def run_params
      params.require(:run).permit(:flow_id, :status, :started_at, :completed_at, :subject_image, :subject_video, :background_reference, :input_image_url, :webhook_url, attachments: [])
    end
